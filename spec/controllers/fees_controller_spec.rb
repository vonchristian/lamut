...
RSpec.describe FeesController, type: :controller do
  ...
  describe "GET #show" do
    it "assigns the requested fee as @fee" do
      fee = Fee.create! valid_attributes
      get :show, params: {id: fee.to_param}, session: valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested fee as @fee" do
      fee = Fee.create! valid_attributes
      get :edit, params: {id: fee.to_param}, session: valid_session
      expect(assigns(:fee)).to eq(fee)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Fee" do
        expect {
          post :create, params: {fee: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved fee as @fee" do
        post :create, params: {fee: invalid_attributes}, session: valid_session
        expect(assigns(:fee)).to be_a_new(Fee)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested fee" do
        fee = Fee.create! valid_attributes
        put :update, params: {id: fee.to_param, fee: new_attributes}, session: valid_session
        fee.reload
      ...
      it "assigns the requested fee as @fee" do
        fee = Fee.create! valid_attributes
        put :update, params: {id: fee.to_param, fee: valid_attributes}, session: valid_session
        expect(assigns(:fee)).to eq(fee)
      end
    ...
    context "with invalid params" do
      it "assigns the fee as @fee" do
        fee = Fee.create! valid_attributes
        put :update, params: {id: fee.to_param, fee: invalid_attributes}, session: valid_session
        expect(assigns(:fee)).to eq(fee)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested fee" do
      fee = Fee.create! valid_attributes
      expect {
        delete :destroy, params: {id: fee.to_param}, session: valid_session
      }.to change(Fee, :count).by(-1)
    end
